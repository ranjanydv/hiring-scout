    ...
    return (
        <div className="space-y-4 col-span-2">
            <div className="flex justify-between items-center">
                <h2 className="text-gray-900 text-xl lg:text-3xl">Job Management</h2>
                <Link href={'#'} className="flex items-center gap-2 font-medium text-[#7433FF] text-base lg:text-xl">
                    Create Job
                    <StackPlus />
                </Link>
            </div>
            <div className="space-y-4 bg-[#e5e5e5] shadow-sm p-4 rounded-lg">
                <div className="flex justify-between items-center py-2">
                    ...
                    <div className= "hidden lg:block bg-white rounded-3xl w-full md:w-3/4">
                        <JobFilter />
                    </div>
                </div>
