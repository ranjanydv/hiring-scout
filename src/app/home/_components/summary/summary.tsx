        ...
        <div className="space-y-4 col-span-2 h-full">
            ...
            <div className="space-y-4 bg-[#e5e5e5] shadow-sm p-4 rounded-lg">
                <div className="space-y-5">
                    ...
                    <SummaryCard summaryText="Recommended candidate pending customer Interview" className='hidden lg:flex' />
                </div>
                <Button variant="link" className="hidden lg:flex text-[#461F99] cursor-pointer">
